...
1. Install NVIDIA HPC SDK (https://developer.nvidia.com/nvidia-hpc-sdk-downloads). Set the environment and ensure nvcc, nvfortran, mpif90 compiler working properly.
